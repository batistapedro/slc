...
class Inicio extends CI_Controller {
	 ...
	 public function __construct()
  {
	...
	public function login()
	{
		...
		{
			$this->form_validation->set_rules('usuario','Usuarios','trim|required|min_length[4]|max_length[25]|regex_match[/^[a-zA-Zñ-Ñ]+$/]');
			...
			else
			{
					...
					else
					{
						$mensaje = array(
							'respuesta'=>'error',
							'error_validar'=>'Este usuario esta temporamente suspendido, debe comunicarse con el administrador del sistema'
						);
					}
