...
<html lang='es'>
    ...
    <link rel="icon" href='./favicon.ico'>
		<title>Coordinación de Licitaciones </title>
...
<!--fin modal de session usuario-->
							...
							<div class='col-xs-12 col-sm-12 col-md-12 col-lg-12'>
								<div class='row'>
									<div class='col-xs-6 col-sm-6 col-md-6 col-lg-6'>
										<img src=<?=base_url("public/img/CNA.png");?> class='img img-responsive center-block'>
									</div>
									<div class='col-xs-6 col-sm-6 col-md-6 col-lg-6'>
										<img src=<?=base_url('public/img/alcasa.jpg');?> class='img img-responsive center-block'>
									</div>
								</div>
							</div>
		...
		<footer class='text-center'>
			<p>
					 ...
					 copy-left 2017 | Desarrollado Por : Ing. Mirla Gutuierrez. <br>
			</p>
			 </footer>
		</header>
	</body>
